...
public class TicketMasterAPI {
	...
	private static final String API_KEY = "uA2WMCQ1acWcA22hBzGbiuxjHerWgOOJ";
	...
	public List<Item> search(double lat, double lon, String keyword) {
        ...
        try {
			keyword = URLEncoder.encode(keyword, "UTF-8"); //need to translate into UTF-8 because we may have special characters
